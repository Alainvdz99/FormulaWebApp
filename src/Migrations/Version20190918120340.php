 ...
 */
final class Version20190918120340 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE race_prediction (id INT AUTO_INCREMENT NOT NULL, fastest_driver_in_quali_id INT NOT NULL, fastest_driver_in_race_id INT NOT NULL, first_place_driver_id INT NOT NULL, second_place_driver_id INT NOT NULL, third_place_driver_id INT NOT NULL, user_id INT NOT NULL, race_id INT NOT NULL, fastest_time VARCHAR(255) NOT NULL, tier_max VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, is_enabled TINYINT(1) NOT NULL, INDEX IDX_55E685519D46E1A8 (fastest_driver_in_quali_id), INDEX IDX_55E68551E2D045D7 (fastest_driver_in_race_id), INDEX IDX_55E685511D39AE11 (first_place_driver_id), INDEX IDX_55E68551E4710F19 (second_place_driver_id), INDEX IDX_55E6855196C8097C (third_place_driver_id), INDEX IDX_55E68551A76ED395 (user_id), INDEX IDX_55E685516E59D40D (race_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
